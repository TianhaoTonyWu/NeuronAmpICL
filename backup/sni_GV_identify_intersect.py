...
parser.add_argument("-t", "--task", type=str, default="task112_asset_simple_sentence_identification.json")
...
paths = [
    f"/home/wth/few_vs_zero/data/sni/matrix/{task}/GV_trace/tp0_5shot.json",
    f"/home/wth/few_vs_zero/data/sni/matrix/{task}/GV_trace/tp1_5shot.json",
    f"/home/wth/few_vs_zero/data/sni/matrix/{task}/GV_trace/tp2_5shot.json",
    f"/home/wth/few_vs_zero/data/sni/matrix/{task}/GV_trace/tp3_5shot.json",
]
...
# 保存结果
folder_path = f"/home/wth/few_vs_zero/data/sni/activation_mask/{task}"
...
torch.save(save_output,folder_path+f"/activation_{args.mod}_{task}_{args.shot}shot_{percent}percent_pth")