...
from few_vs_zero.src.globals_vars import today, MAX_TOKEN_FOR_SNI
...
mask_path = f"/home/wth/few_vs_zero/data/sni/activation_mask/{task}/activation_{args.mod}_{task}_{args.mask_shot}shot_{args.percent}percent_pth"
