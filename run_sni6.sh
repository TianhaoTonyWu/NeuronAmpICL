...
python src/evaluate.py -x 1.4 -mask "/root/few_vs_zero/data/sni/k1/task242/activation_mask/GV_last/0.5p.pth" -in "/root/few_vs_zero/data/sni/k1token/task242/tp4/test_0.pkl" 
